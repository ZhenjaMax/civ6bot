export class CommunityConfig{
    ...
    remap: string = `**__Ремап__** (remap) – голосование за смену игровой карты из-за объективно плохой стартовой локации одного из игроков.
            ...
            **__Авторемап__** – ремап, который не требует голосования для его проведения. Не учитывается при подсчете голосов за ремап. Может произойти в FFA до 15 хода включительно.
            ...
            • Вы не можете основать 3 новых города в радиусе 5 клеток от своего изначального местоположения (без учета других городов, кроме столиц и городов-государств) без изучения дополнительных технологий или социальных институтов на картах:
            **• Пангея;**
            **• Континенты;**
            **• Нагорье;**
            **• Внутреннее море;**
